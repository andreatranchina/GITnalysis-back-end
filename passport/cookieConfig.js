...
const cookieConfig =
    {
        ...
        secure: false, // Required to enable cookies to go through https for better security
        httpOnly: false, // Not allowing client-side javascript to interact with cookie, thus increasing security
